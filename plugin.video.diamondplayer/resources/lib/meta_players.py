...
class AddonPlayer(object):
	...
	def postprocess(self, link):
		...
		if not code or not isinstance(code, str) or '__' in code:
			return link
...
def get_players(media, filters={}):
	...
	players = []
	players_path = 'special://profile/addon_data/plugin.video.diamondplayer/Players/'
...
def sort_players(players, filters={}):
	...
	for player in players:
		filtered = False
		checked = False
		for filter_key, filter_value in list(filters.items()):
