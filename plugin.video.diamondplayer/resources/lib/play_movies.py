import re, urllib.request, urllib.parse, urllib.error, datetime
import xbmc
...
def get_movie_parameters(movie):
	...
	parameters['year'] = movie['release_date']
	...
	parameters['urltitle'] = urllib.parse.quote(parameters['title'])
	parameters['sorttitle'] = parameters['title']
	articles = ['a ', 'A ', 'An ', 'an ', 'The ', 'the ']
	for article in articles:
		if parameters['title'].startswith(article):
			parameters['sorttitle'] = parameters['title'].replace(article,'')
	...
	parameters['name'] = '%s (%s)' % (parameters['title'], parameters['year'])
	parameters['urlname'] = urllib.parse.quote(parameters['name'])
	parameters['released'] = movie['release_date']
