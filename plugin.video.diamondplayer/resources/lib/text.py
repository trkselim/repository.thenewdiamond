import re, time, urllib.request, urllib.parse, urllib.error, urllib.parse
...
def urlencode_path(path):
	...
	path = urllib.parse.urlunparse([o.scheme, o.netloc, o.path, o.params, urllib.parse.urlencode(query, True), o.fragment])
	return path
