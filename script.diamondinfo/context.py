...
if __name__ == '__main__':
	base = 'RunScript(script.diamondinfo,info='
	...
	if type   == 'movie':
		xbmc.executebuiltin('%sdiamondinfo,dbid=%s,id=%s,imdb_id=%s,name=%s)' % (base, dbid, remote_id, info.getIMDBNumber(), info.getTitle()))
	elif type == 'tvshow':
